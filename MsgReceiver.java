...
public class MsgReceiver extends ViewableAtomic {
    ...
    protected Vector<ArrayList<Object>> respondMsg;
    ...
    public void crtWhatYouHaveMsg(int msgID, Vector<Integer> srcID, int nTraitors) {
    ...
    public void crtRespondMsg(int msgID) {
        ...
        if (type == 0)
            ...
            temp.add(makeFakeMsg(netStat.msg));
        }
        respondMsg.add(temp);
    }
    ...
    /**
     * Check if the node gets all the responds that he is waiting for.
     */
